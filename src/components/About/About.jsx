        ...
        <div className="col-span-2 grid gap-5  grid-cols-3 p-5 rounded-xl bg-sky-500 shadow-md">
          ...
          <div className="col-span-2 bg-white rounded-xl shadow-md p-5 space-y-3">
            ...
            <p className="text-base">
              ...
              Express.js, MongoDB, allowing me to deliver end-to-end solutions.
              I thrive on challenges, continuously learn, and am committed to
              turning your ideas into powerful online realities. Let's
